...
<div class="page-content">
    ...
    <div class='container'>
        <form id="billing_form" method="post" action="{{URL::to('/confirm-booking')}}">
            @csrf
            <div class="row">
                <div class="col-sm-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-check form-radio-primary mb-1">
                                        <input class="form-check-input" type="radio" name="user_type" id="type1"
                                            value="existing_user" onclick="showBookingDiv($(this).val());">
                                        <label class="form-check-label" for="type1">Existing User</label>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-check form-radio-primary mb-1">
                                        <input class="form-check-input" type="radio" name="user_type" id="type2"
                                            value="new_user" onclick="showBookingDiv($(this).val());">
                                        <label class="form-check-label" for="type2">Create New User</label>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-check form-radio-primary mb-1">
                                        <input class="form-check-input" type="radio" name="user_type" id="type3"
                                            value="guest_user" onclick="showBookingDiv($(this).val());">
                                        <label class="form-check-label" for="type3">Guest User</label>
                                    </div>
                                </div>
                            </div>
                            <div class="row gy-4 mt-2" id="existing_user_div" style="display:none;">
                                <div class="col-lg-2">
                                ...
                                <div class="row gy-4 mt-5" id="existing_user_info_div" style="display:none;">
                                    ...
                                    <div class="w-100"></div> <!-- Ensures the next block starts from a new line -->
                                    <div class="col-md-3">
                                        <div>
                            ...
                            <div class="row gy-4 mt-2" id="new_user_div" style="display:none">
                                <h4 style="color:#8c68cd;">User Basic Information</h4>
                                ...
                                <div class="w-100">
                                    <hr>
                                </div> <!-- Ensures the next block starts from a new line -->
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="postal_code" class="form-label">Zip/Post Code</label>
                            ...
                            <div class="row gy-4 mt-2">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="identity_number" class="form-label">Number</label>
                                        <input type="text" class="form-control" id="identity_number"
                                            name="identity_number" placeholder="Enter Number">
                                    </div>
                                </div>

                                <div class="col-md-3" id="expire_date_div">
                                    <div class="form-group">
                        ...
                        <div class="card-body" id="summary_div">
                            <ul class="list-group">
                                <li class="list-group-item">
                                    ...
                                    <span id="date_range">{{$booking_data_temp['check_in']}}&nbsp; -
                                        &nbsp;{{$booking_data_temp['check_out']}}</span>
                                </li>
                                <li class="list-group-item">
                                    <b style="color:#495057;margin-right: 10%;">Nights:</b>
                                    <span id="no_of_days">{{round((strtotime($booking_data_temp['check_out']) -
                                        strtotime($booking_data_temp['check_in'])) / (60 * 60 * 24))}}</span>
                                </li>
                                <li class="list-group-item">
                                    <?php $total = 0; ?>
                                    ...
                                    <div>
                                        ...
                                        <span>{{array_sum($book['people_adult'])}} Adults
                                            {{array_sum($book['people_child'])}} Children
                                            ({{count($booking_data_temp['booking_data'])}} Room)</span>
                                        <div class="w-100 text-end" style="color: #8c68cd">BDT&nbsp;<span
                                                class="room-rent">{{$book['room_price']}}</span></div>
                                    </div>
                                ...
                                <li class="list-group-item">
                                    ...
                                    <b class="float-end" style="font-size: 20px;color: #8c68cd"
                                        id="final_total">{{$total}}</b>
                                </li>
                            </ul>
                            <button type="submit" class="btn btn-primary waves-effect waves-light w-100">Pay
                                Now</button>
                        </div>
                    </div>
                </div>
    ...
    $(document).ready(function() {
        $.getJSON(baseUrl + "assets/json/country-list.json", function(data) {
            ...
            $.each(data, function(key, value) {
                options += '<option value="' + value.countryName + '">' + value.countryName +
                    '</option>';
            });
