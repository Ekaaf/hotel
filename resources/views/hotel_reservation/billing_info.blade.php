            ...
            <div class="col-sm-8">
                <div class="container">
                    ...
                    <div class="card-body">
                        ...
                        <div class="container mt-5" id="new_user_div" style="display:none">
                            <div class="row gy-4">
                                <div class="col-12">
                                    <div class="header">User Basic Information</div>
                                </div>
                                ...
                                <div class="col-xxl-4 col-md-6">
                                    <div>
                                        <label for="zip_code" class="form-label">Zip/Post Code</label>
            ...
            <div class="col-sm-4">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0 text-center">Booking Info</h4>
                    </div>
                    <div class="card-body" id="summary_div">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item">
                                ...
                                <div>
                                    <b style="color:#495057;margin-right: 10%;">{{$book['room_category_id']}}:</b>
                                    <span>{{array_sum($book['people_adult'])}} Adults
                                        {{array_sum($book['people_adult'])}} Children
